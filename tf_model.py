    ...
    def multidimensional_viterbi(self, evidence_vector, states, prior_probs,
        ...
        for i in range(len(states)):
            ...
            for z in range(ndim):
                ...
                prod = prod + np.log(self.gaussian_prob(evidence_vector[0][z], emission_paras[states[i]][z]))
        ...
        for i in range(1, len(evidence_vector)):
            for j in range(len(states)):
                ...
                for z in range(ndim):
                    ...
                    a = a + np.log(self.gaussian_prob(evidence_vector[i][z], emission_paras[state][z]))
